...
NotesDirectoryList = ["Reconnaissance", "Exploitation", "Post Exploitation", "Malware Analysis", "Malware Development", "Reverse Engineering", "Forensics" , "Cryptography", "Networking", "Web"]
