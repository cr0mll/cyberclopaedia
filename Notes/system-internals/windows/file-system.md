...
![](<../../System Internals/Windows/Resources/Images/File System/icacls Inspect Permissions.png>)
...
![](<../../System Internals/Windows/Resources/Images/File System/Inspect Folder Permissions.png>)
...
Every file in NTFS has at least one default data stream where its data is stored. The default data stream is innominate and any stream which _does_ have a name is considered an alternate data stream.
...
![](<../../System Internals/Windows/Resources/Images/File System/Oblivious Windows Explorer.png>)

Windows Explorer is completely oblivious to the alternate data stream. The command-line, however, is not:

![](<../../System Internals/Windows/Resources/Images/File System/Read ADS.png>)

Additionally, the `dir /R` command can be used to list alternate data streams for files in a directory:

![](<../../System Internals/Windows/Resources/Images/File System/Show ADSs.png>)
...
![](<../../System Internals/Windows/Resources/Images/File System/Streams Recurse Folders.png>)
...
![](<../../System Internals/Windows/Resources/Images/File System/Delete All Streams.png>)
